...
export const buildCondensedMatchPayload = (source: Record<string, unknown>) => {
    ...
    return {
        ...
        'p1-knockdowns': safeNumber(source['p1-knockdowns']),
        'p2-knockdowns': safeNumber(source['p2-knockdowns']),
        'p1-fast-wakeups': safeNumber(source['p1-fast-wakeups']),
        'p2-fast-wakeups': safeNumber(source['p2-fast-wakeups']),
        'p1-parries': safeNumber(source['p1-parries']),
        'p2-parries': safeNumber(source['p2-parries']),
        'p1-throws': safeNumber(source['p1-throws']),
        'p2-throws': safeNumber(source['p2-throws']),
        'p1-throw-whiffs': safeNumber(source['p1-throw-whiffs']),
        'p2-throw-whiffs': safeNumber(source['p2-throw-whiffs']),
        'p1-supers-used': safeNumber(source['p1-supers-used']),
        'p2-supers-used': safeNumber(source['p2-supers-used']),
        'p1-throw-techs': safeNumber(source['p1-throw-techs']),
        'p2-throw-techs': safeNumber(source['p2-throw-techs']),
        participants: {
            player1: {
